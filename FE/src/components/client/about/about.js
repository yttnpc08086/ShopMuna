...
import About01 from "../../../assets/client/images/about-01.jpg";
import About02 from "../../../assets/client/images/about-02.jpg";
const About = () => {
  return (
    <div className='pt-5'>
      {/* Title page */}
      <section className="bg-img1-about txt-center p-lr-15 p-tb-92">
