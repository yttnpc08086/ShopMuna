...
import ItemCart04 from "../../../assets/client/images/item-cart-04.jpg";
import ItemCart05 from "../../../assets/client/images/item-cart-05.jpg";

const ShoppingCart = () => {
  return (
    <div className='pt-5'>
      {/* <!-- breadcrumb --> */}
	<div className="shopping-cart-client pt-5">
	...
	<form className="bg0 p-t-75 p-b-85">
		<div className="shopping-cart-client">
			<div className="row">
