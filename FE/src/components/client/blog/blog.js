...
import Blog05 from "../../../assets/client/images/blog-05.jpg";
import Blog06 from "../../../assets/client/images/blog-06.jpg";
...
import ProductMin03 from "../../../assets/client/images/product-min-03.jpg";
const Blog = () => {
  return (
    <div className="pt-5">
      {/* Title page */}
      <section className="bg-img1-blog txt-center p-lr-15 p-tb-92">
            ...
            <div className="col-md-4 col-lg-3 p-b-80">
              <div className="side-menu">
                ...
                <div className="p-t-65">
                  ...
                  <ul>
                    {/* Repeat for each featured product */}
                    ...
                    <li class="flex-w flex-t p-b-30">
                      <a
                        ...
                        class="wrao-pic-w size-214 hov-ovelay1 m-r-20"
                      >
                        <img src={ProductMin03} alt="PRODUCT" />
                      </a>
